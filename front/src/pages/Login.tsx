...
export default function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-cover bg-center bg-[url('https://react.vristo.sbthemes.com/assets/images/auth/map.png')] dark:bg-[url('https://react.vristo.sbthemes.com/assets/images/auth/map-dark.png')]">
      <div className="panel sm:w-[480px] m-6 max-w-lg w-full">
        <h2 className="font-bold text-primary text-2xl mb-3">Sign In</h2>
        ...
        <form className="space-y-5" onSubmit={submitForm}>
          ...
          <div>
            <label className="cursor-pointer flex place-items-center gap-x-2">
